...
According to @tbl-summarize_the_information_from_time_at_shelter_2, we can find that the mean of the time_at_shelter is not equal to the median, the variance of time_at_shelter is much larger than the mean. This situation should be considered more in the part of formal analysis.
